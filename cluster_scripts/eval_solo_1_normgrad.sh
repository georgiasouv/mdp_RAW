...
# ============================================================
#  eval solo_1_normgrad  ->  vs fcos, fasterrcnn, detr, retinanet
# ============================================================
...
export WANDB_RUN_GROUP=eval__solo_1_normgrad
...
echo "=== Evaluating solo_1_normgrad against all detectors ==="
for DET in fcos fasterrcnn detr retinanet; do
    ...
    python -m core.evaluate \
        ...
        --dataset pascalraw \
        --num-classes 3 \
        --out results/eval_normgrad/solo_1_normgrad__${DET}.json \
        --wandb \
        --wandb-name solo_1_normgrad__eval_${DET}
done
