...
#SBATCH --job-name=pair_12_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_12_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_12_normgrad_%j.err
# ============================================================
#  pair_12_normgrad  (regime=pair_12, combiner=normgrad)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting pair_12_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__pair_12_normgrad
...
echo "=== pair_12_normgrad finished ==="
