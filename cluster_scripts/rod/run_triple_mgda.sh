...
#SBATCH --job-name=rod_triple_mgda
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/triple_mgda_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/triple_mgda_%j.err
# ============================================================
#  ROD triple_mgda  (regime=triple, combiner=mgda)
# ============================================================
...
echo "=== Starting ROD triple_mgda ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__triple_mgda
