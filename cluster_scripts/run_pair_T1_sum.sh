...
#SBATCH --job-name=pair_T1_sum
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_T1_sum_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_T1_sum_%j.err
# ============================================================
#  pair_T1_sum  (regime=pair_T1, combiner=sum)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting pair_T1_sum ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__pair_T1_sum
