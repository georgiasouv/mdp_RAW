...
#SBATCH --job-name=solo_1_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/solo_1_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/solo_1_normgrad_%j.err
# ============================================================
#  solo_1_normgrad  (regime=solo_1, combiner=normgrad)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting solo_1_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__solo_1_normgrad
