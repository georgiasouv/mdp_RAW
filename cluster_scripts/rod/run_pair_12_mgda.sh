...
#SBATCH --job-name=rod_pair_12_mgda
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_12_mgda_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_12_mgda_%j.err
# ============================================================
#  ROD pair_12_mgda  (regime=pair_12, combiner=mgda)
# ============================================================
...
echo "=== Starting ROD pair_12_mgda ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__pair_12_mgda
...
echo "=== ROD pair_12_mgda finished ==="
