...
#SBATCH --job-name=pair_12_mgda
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_12_mgda_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_12_mgda_%j.err
# ============================================================
#  pair_12_mgda  (regime=pair_12, combiner=mgda)  FRESH 0->80
# ============================================================
# -- Environment --------------------------------------------------
...
echo "=== Starting pair_12_mgda ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"
OUT=runs/pascalraw__pair_12_mgda
python -m core.train \
    --regime pair_12 \
    --dataset pascalraw \
    --num-classes 3 \
