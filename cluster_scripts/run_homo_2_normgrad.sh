...
#SBATCH --job-name=homo_2_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/homo_2_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/homo_2_normgrad_%j.err
# ============================================================
#  homo_2_normgrad  (regime=homo_2, combiner=normgrad)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting homo_2_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__homo_2_normgrad
