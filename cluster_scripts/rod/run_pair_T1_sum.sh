...
#SBATCH --job-name=rod_pair_T1_sum
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_T1_sum_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_T1_sum_%j.err
# ============================================================
#  ROD pair_T1_sum  (regime=pair_T1, combiner=sum)
# ============================================================
...
echo "=== Starting ROD pair_T1_sum ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__pair_T1_sum
