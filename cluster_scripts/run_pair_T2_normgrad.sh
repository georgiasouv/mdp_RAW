...
#SBATCH --job-name=pair_T2_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_T2_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_T2_normgrad_%j.err
# ============================================================
#  pair_T2_normgrad  (regime=pair_T2, combiner=normgrad)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting pair_T2_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__pair_T2_normgrad
...
echo "=== pair_T2_normgrad finished ==="
