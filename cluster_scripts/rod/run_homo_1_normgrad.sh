...
#SBATCH --job-name=rod_homo_1_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/homo_1_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/homo_1_normgrad_%j.err
# ============================================================
#  ROD homo_1_normgrad  (regime=homo_1, combiner=normgrad)
# ============================================================
...
echo "=== Starting ROD homo_1_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__homo_1_normgrad
...
echo "=== ROD homo_1_normgrad finished ==="
