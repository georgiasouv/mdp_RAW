...
#SBATCH --job-name=rod_homo_T_pcgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/homo_T_pcgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/homo_T_pcgrad_%j.err
# ============================================================
#  ROD homo_T_pcgrad  (regime=homo_T, combiner=pcgrad)
# ============================================================
...
echo "=== Starting ROD homo_T_pcgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__homo_T_pcgrad
...
echo "=== ROD homo_T_pcgrad finished ==="
