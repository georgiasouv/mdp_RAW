...
#SBATCH --job-name=homo_T_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/homo_T_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/homo_T_normgrad_%j.err
# ============================================================
#  homo_T_normgrad  (regime=homo_T, combiner=normgrad)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting homo_T_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__homo_T_normgrad
