...
#SBATCH --job-name=homo_T_mgda
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/homo_T_mgda_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/homo_T_mgda_%j.err
# ============================================================
#  homo_T_mgda  (regime=homo_T, combiner=mgda)  FRESH 0->80
# ============================================================
# -- Environment --------------------------------------------------
...
echo "=== Starting homo_T_mgda ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"
OUT=runs/pascalraw__homo_T_mgda
python -m core.train \
    --regime homo_T \
    --dataset pascalraw \
    --num-classes 3 \
