...
#SBATCH --job-name=triple_sum
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_sum_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_sum_%j.err
# ============================================================
#  triple_sum  (regime=triple, combiner=sum)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting triple_sum ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__triple_sum
