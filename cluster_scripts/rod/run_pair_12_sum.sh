...
#SBATCH --job-name=rod_pair_12_sum
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_12_sum_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_12_sum_%j.err
# ============================================================
#  ROD pair_12_sum  (regime=pair_12, combiner=sum)
# ============================================================
...
echo "=== Starting ROD pair_12_sum ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__pair_12_sum
