...
#SBATCH --job-name=triple_pcgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_pcgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_pcgrad_%j.err
# ============================================================
#  triple_pcgrad  (regime=triple, combiner=pcgrad)  FRESH 0->80
# ============================================================
# -- Environment --------------------------------------------------
...
echo "=== Starting triple_pcgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"
OUT=runs/pascalraw__triple_pcgrad
python -m core.train \
    --regime triple \
    --dataset pascalraw \
    --num-classes 3 \
