...
#SBATCH --job-name=pair_12_cagrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_12_cagrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_12_cagrad_%j.err
# ============================================================
#  pair_12_cagrad  (regime=pair_12, combiner=cagrad)  FRESH 0->80
# ============================================================
# -- Environment --------------------------------------------------
...
echo "=== Starting pair_12_cagrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"
OUT=runs/pascalraw__pair_12_cagrad
python -m core.train \
    --regime pair_12 \
    --dataset pascalraw \
    --num-classes 3 \
