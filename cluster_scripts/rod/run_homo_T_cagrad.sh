...
#SBATCH --job-name=rod_homo_T_cagrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/homo_T_cagrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/homo_T_cagrad_%j.err
# ============================================================
#  ROD homo_T_cagrad  (regime=homo_T, combiner=cagrad)
# ============================================================
...
echo "=== Starting ROD homo_T_cagrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__homo_T_cagrad
...
echo "=== ROD homo_T_cagrad finished ==="
