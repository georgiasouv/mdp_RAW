...
JOBS=(
  "solo_1   normgrad 10:00:00 test"   # 1  A baseline  FCOS
  "solo_2   normgrad 10:00:00 test"   # 2  A baseline  Faster R-CNN
  "solo_T   normgrad 14:00:00 test"   # 3  A baseline  DETR
  "pair_12  normgrad 12:00:00 test"   # 4  A headline  FCOS+FRCNN
  "pair_T1  normgrad 16:00:00 test"   # 5  A headline  DETR+FCOS
  "pair_T2  normgrad 16:00:00 test"   # 6  A headline  DETR+FRCNN
  "triple   normgrad 18:00:00 test"   # 7  A headline  all 3
  "homo_1   normgrad 12:00:00 test"   # 8  B control   FCOS x3
  "homo_2   normgrad 12:00:00 test"   # 9  B control   FRCNN x3
  "homo_T   normgrad 20:00:00 test"   # 10 B control   DETR x3
  "pair_12  sum      12:00:00 test"   # 11 C ablation  naive sum
  "pair_T1  sum      16:00:00 test"   # 12 C ablation  naive sum, DETR regime
  "triple   sum      18:00:00 test"   # 13 C ablation  naive sum, full ensemble
)
