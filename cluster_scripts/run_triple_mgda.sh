...
#SBATCH --job-name=triple_mgda
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_mgda_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_mgda_%j.err
# ============================================================
#  triple_mgda  (regime=triple, combiner=mgda)  FRESH 0->80
# ============================================================
# -- Environment --------------------------------------------------
...
echo "=== Starting triple_mgda ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"
OUT=runs/pascalraw__triple_mgda
python -m core.train \
    --regime triple \
    --dataset pascalraw \
    --num-classes 3 \
