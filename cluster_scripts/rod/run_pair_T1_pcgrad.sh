...
#SBATCH --job-name=rod_pair_T1_pcgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_T1_pcgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_T1_pcgrad_%j.err
# ============================================================
#  ROD pair_T1_pcgrad  (regime=pair_T1, combiner=pcgrad)
# ============================================================
...
echo "=== Starting ROD pair_T1_pcgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__pair_T1_pcgrad
...
echo "=== ROD pair_T1_pcgrad finished ==="
