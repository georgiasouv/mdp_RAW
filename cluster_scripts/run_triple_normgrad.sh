...
#SBATCH --job-name=triple_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_normgrad_%j.err
# ============================================================
#  triple_normgrad  (regime=triple, combiner=normgrad)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting triple_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__triple_normgrad
