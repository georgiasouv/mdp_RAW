...
#SBATCH --job-name=triple_cagrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_cagrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/triple_cagrad_%j.err
# ============================================================
#  triple_cagrad  (regime=triple, combiner=cagrad)  FRESH 0->80
# ============================================================
# -- Environment --------------------------------------------------
...
echo "=== Starting triple_cagrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"
OUT=runs/pascalraw__triple_cagrad
python -m core.train \
    --regime triple \
    --dataset pascalraw \
    --num-classes 3 \
