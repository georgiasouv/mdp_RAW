...
#SBATCH --job-name=rod_homo_2_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/homo_2_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/homo_2_normgrad_%j.err
# ============================================================
#  ROD homo_2_normgrad  (regime=homo_2, combiner=normgrad)
# ============================================================
...
echo "=== Starting ROD homo_2_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__homo_2_normgrad
...
echo "=== ROD homo_2_normgrad finished ==="
