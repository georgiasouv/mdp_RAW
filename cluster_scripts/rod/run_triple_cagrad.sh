...
#SBATCH --job-name=rod_triple_cagrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/triple_cagrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/triple_cagrad_%j.err
# ============================================================
#  ROD triple_cagrad  (regime=triple, combiner=cagrad)
# ============================================================
...
echo "=== Starting ROD triple_cagrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__triple_cagrad
...
echo "=== ROD triple_cagrad finished ==="
