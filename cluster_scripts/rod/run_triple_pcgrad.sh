...
#SBATCH --job-name=rod_triple_pcgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/triple_pcgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/triple_pcgrad_%j.err
# ============================================================
#  ROD triple_pcgrad  (regime=triple, combiner=pcgrad)
# ============================================================
...
echo "=== Starting ROD triple_pcgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__triple_pcgrad
...
echo "=== ROD triple_pcgrad finished ==="
