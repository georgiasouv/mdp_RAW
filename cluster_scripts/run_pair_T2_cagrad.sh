...
#SBATCH --job-name=pair_T2_cagrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_T2_cagrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_T2_cagrad_%j.err
# ============================================================
#  pair_T2_cagrad  (regime=pair_T2, combiner=cagrad)  FRESH 0->80
# ============================================================
# -- Environment --------------------------------------------------
...
echo "=== Starting pair_T2_cagrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"
OUT=runs/pascalraw__pair_T2_cagrad
python -m core.train \
    --regime pair_T2 \
    --dataset pascalraw \
    --num-classes 3 \
