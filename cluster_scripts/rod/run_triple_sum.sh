...
#SBATCH --job-name=rod_triple_sum
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/triple_sum_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/triple_sum_%j.err
# ============================================================
#  ROD triple_sum  (regime=triple, combiner=sum)
# ============================================================
...
echo "=== Starting ROD triple_sum ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__triple_sum
