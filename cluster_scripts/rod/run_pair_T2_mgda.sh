...
#SBATCH --job-name=rod_pair_T2_mgda
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_T2_mgda_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_T2_mgda_%j.err
# ============================================================
#  ROD pair_T2_mgda  (regime=pair_T2, combiner=mgda)
# ============================================================
...
echo "=== Starting ROD pair_T2_mgda ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__pair_T2_mgda
...
echo "=== ROD pair_T2_mgda finished ==="
