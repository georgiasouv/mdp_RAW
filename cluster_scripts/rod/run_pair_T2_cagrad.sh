...
#SBATCH --job-name=rod_pair_T2_cagrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_T2_cagrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs_rod/pair_T2_cagrad_%j.err
# ============================================================
#  ROD pair_T2_cagrad  (regime=pair_T2, combiner=cagrad)
# ============================================================
...
echo "=== Starting ROD pair_T2_cagrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs_rod/rod__pair_T2_cagrad
...
echo "=== ROD pair_T2_cagrad finished ==="
