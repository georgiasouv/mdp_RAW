...
#SBATCH --job-name=homo_1_normgrad
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/homo_1_normgrad_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/homo_1_normgrad_%j.err
# ============================================================
#  homo_1_normgrad  (regime=homo_1, combiner=normgrad)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting homo_1_normgrad ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__homo_1_normgrad
