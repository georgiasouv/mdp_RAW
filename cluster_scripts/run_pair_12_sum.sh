...
#SBATCH --job-name=pair_12_sum
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_12_sum_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/pair_12_sum_%j.err
# ============================================================
#  pair_12_sum  (regime=pair_12, combiner=sum)
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting pair_12_sum ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__pair_12_sum
