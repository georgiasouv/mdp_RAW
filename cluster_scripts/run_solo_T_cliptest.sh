...
#SBATCH --job-name=solo_T_cliptest
#SBATCH --output=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/solo_T_cliptest_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/raw-mdp/cluster_scripts/logs/solo_T_cliptest_%j.err
# ============================================================
...
# -- Training -----------------------------------------------------
echo "=== Starting solo_T_cliptest ==="
cd /networkhome/WMGDS/souval_g/raw-mdp
export PYTHONPATH="$(pwd):${PYTHONPATH}"

OUT=runs/pascalraw__solo_T_cliptest
